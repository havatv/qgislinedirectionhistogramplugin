...
#
# Prepare topology by joining lines over pseudo nodes
#							 -------------------
#		begin				: 2015-01-10
#		git sha				: $Format:%H$
...
UI_FILES = linedirectionhistogram_dialog_base.ui
